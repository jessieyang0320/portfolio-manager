...
# Call the api and extract the stock info from the returned object
  def quote_hash
  	...
  	returned_instance = portfolio.quotes(stock, [:name,:last_trade_date,:last_trade_price, :ask])
    returned_instance[0]
  end  
  ...
  # Returns an array of purchased_stock values of last year's data monthly
